...
object Config {
  ...
  /**
   * Used to overwrite the default Play configuration for a fake application.
   */
  val additionalConfig: Map[String, Any] = Map()
}
...
object MongoConfig {
   ...
   */
  val additionalConfig = Config.additionalConfig ++ Map(
